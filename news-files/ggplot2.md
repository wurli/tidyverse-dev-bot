...
-   !begin-bullet!
    ...
    is recommended to update all code to reflect the new aesthetic
    (@thomasp85, #3672)
...
-   !begin-bullet!
    ...
    !end-bullet!
-   !begin-bullet!
    VISUAL CHANGE: `scale_*_viridis_b()` now uses the full range of the
    viridis scales (@gregleleu, #4737)
...
-   !begin-bullet!
    ...
    resulted in fracional dates would get misaligned (@thomasp85, #3965)
...
-   !begin-bullet!
    ...
    `facet_grid()` now crrectly throws an error (@thomasp85, #3834)
...
-   !begin-bullet!
    ...
    thrown. In earlier versions the first occuring column was chosen
...
-   !begin-bullet!
    ...
    timezone attached to the varaible by default, but can be overridden
...
1.  !begin-bullet!
    `scale_x_discrete()` and `scale_y_discrete()` always show discrete
...
2.  !begin-bullet!
    ...
    !end-bullet!
3.  !begin-bullet!
    All discrete scales gain a `na.translate` argument that allows you
...
-   !begin-bullet!
    ...
    !end-bullet!
-   !begin-bullet!
    Tighly linked geoms and stats (e.g. `geom_boxplot()` and
...
-   !begin-bullet!
    ...
    deafult smoothing method is, look it up in the documentation!
    (#1247)
...
-   !begin-bullet!
    ...
    function. To use the default lable, use `waiver()` (#1145).
