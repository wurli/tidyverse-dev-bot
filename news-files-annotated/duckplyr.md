...
-   !begin-bullet!
    ...
    !end-bullet!
-   !begin-bullet!
    Add superseded lifecycle badge to `transmute()` documentation (#364,
    #824).
...
-   !begin-bullet!
    `read_file_duckdb()` only wraps `path` into a list if the length is
    not equal to one, to support `read_stat()`.
    !end-bullet!
...
-   !begin-bullet!
    ...
    !end-bullet!
-   !begin-bullet!
    Threshold for `prudence = "thrifty"` is reduced to 1000 cells when
    the data comes from a remote data source.
