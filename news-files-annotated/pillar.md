...
-   !begin-bullet!
    `print()` and `format()` pass on `...` to `tbl_format_setup()`
    again, as documented (@thothal, #726).

    !end-bullet!
-   !begin-bullet!
    Show up to 20 rows by default for lazy tables again, regression
    introduced in pillar 1.10.0 (#727).
...
-   !begin-bullet!
    Add color to commas for `tibble::glimpse()` (@TSchiefer, #658,
    #734).
    !end-bullet!
...
-   !begin-bullet!
    Compatibility with upcoming ggplot2 (@teunbrand,
    tidyverse/ggplot2#6361, #729).
    !end-bullet!
