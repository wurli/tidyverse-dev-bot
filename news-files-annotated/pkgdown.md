...
-   !begin-bullet!
    Make `build_llm_docs()` more robust to the use of old Pandoc
    (@nanxstats, @galachad, #2952, #2954)
    !end-bullet!
...
-   !begin-bullet!
    ...
    !end-bullet!
-   !begin-bullet!
    New translations were add for Dutch (`nl`) and Japanese (`ja`),
    thanks to @pepijn-devires and @shikokuchuo respectively.
    !end-bullet!
-   !begin-bullet!
...
-   !begin-bullet!
    ...
    necessary components using CDN (#2704).
    !end-bullet!
-   !begin-bullet!
    Articles have improved test cases (thanks to @venpopov and
    @ethanbass).
    !end-bullet!
-   !begin-bullet!
...
-   !begin-bullet!
    ...
    re-generated by manually removing the `pkgdown/favicon` directory
