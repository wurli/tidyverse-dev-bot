...
-   !begin-bullet!
    `github_lock_branch()` and `github_unlock_branch()` are new
    functions to lock and unlock a GitHub branch, which is now part of
    the release checklist generated by `use_release_issue()` (#2145).
    !end-bullet!
-   !begin-bullet!
