...
-   !begin-bullet!
    ...
    -   !begin-bullet!
        ...
        `vctrs::vec_group_id()` instead. If your package uses NSE and
        implicitly relied on the variable `id` being available, you now
        need to put `utils::globalVariables("id")` inside one of your
        package files to tell R that `id` is a column name.
    ...
    -   !begin-bullet!
        ...
        !end-bullet!
    -   !begin-bullet!
        `bench_tbls()`, `compare_tbls()`, `compare_tbls2()`,
        `eval_tbls()`, and `eval_tbls2()`. Deprecated in 1.0.0 (May
        2020).

        !end-bullet!
    -   !begin-bullet!
        `location()` and `changes()`. Deprecated in 1.0.0 (May 2020),
        use `lobstr::ref()` instead.
...
-   !begin-bullet!
    ...
    -   !begin-bullet!
        ...
        !end-bullet!
    -   !begin-bullet!
        `filter()` with a 1 column matrix. Deprecated in 1.1.0 (Jan
        2023), use a vector instead.

        !end-bullet!
    -   !begin-bullet!
        `slice()` with a 1 column matrix. Deprecated in 1.1.0 (Jan
        2023), use a vector instead.
...
-   !begin-bullet!
    ...
    !begin-bullets-13!
    -   !begin-bullet!
        `cur_data()` and `cur_data_all()`. Deprecated in 1.1.0 (Jan
        2023), use `pick()` instead.

        !end-bullet!
    -   !begin-bullet!
        The `...` argument of `across()`. Deprecated in 1.1.0 (Jan
        2023), use an anonymous function instead.
