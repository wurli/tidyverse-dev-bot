...
-   !begin-bullet!
    ...
    This work is a result of Tidyup 8: Expanding the `filter()` family,
    with a lot of great feedback from the community (#6560, #6891).
...
-   !begin-bullet!
    ...
    -   !begin-bullet!
        ...
        !end-bullet!
    -   !begin-bullet!
        When called with one input, both now return logical vectors
...
-   !begin-bullet!
    ...
    !begin-bullets-7!
    -   !begin-bullet!
        `combine()`. Deprecated in 1.0.0, use `c()` or `vctrs::vec_c()`
        instead.

        !end-bullet!
    -   !begin-bullet!
        `src_mysql()`, `src_postgres()`, `src_sqlite()`, `src_local()`,
        and `src_df()`. Deprecated in 1.0.0, use `tbl()` instead.

        !end-bullet!
    -   !begin-bullet!
        `tbl_df()` and `as.tbl()`. Deprecated in 1.0.0, use
        `tibble::as_tibble()` instead.

        !end-bullet!
    -   !begin-bullet!
        `add_rownames()`. Deprecated in 1.0.0, use
        `tibble::rownames_to_column()` instead.

        !end-bullet!
    -   !begin-bullet!
        The `.drop` argument of `add_count()`. Deprecated in 1.0.0, had
        no effect.
    ...
    -   !begin-bullet!
        ...
        Deprecated in 1.0.0, use `group_by()` first.

        !end-bullet!
    -   !begin-bullet!
        The `keep` argument of `group_map()`, `group_modify()`, and
        `group_split()`. Deprecated in 1.0.0, use `.keep` instead.
    ...
    -   !begin-bullet!
        ...
        Deprecated in 1.1.0, use `reframe()` instead.
    ...
    -   !begin-bullet!
        ...
        use `relationship = "many-to-one"` instead.
...
-   !begin-bullet!
    ...
    -   !begin-bullet!
        ...
        !end-bullet!
    -   !begin-bullet!
        `filter()` with a 1 column matrix. Deprecated in 1.1.0, use a
        vector instead.

        !end-bullet!
    -   !begin-bullet!
        `slice()` with a 1 column matrix. Deprecated in 1.1.0, use a
        vector instead.
    ...
    -   !begin-bullet!
        ...
        !end-bullet!
    -   !begin-bullet!
        `group_indices()` with no arguments. Deprecated in 1.0.0, use
        `cur_group_id()` instead.
...
-   !begin-bullet!
    ...
    !begin-bullets-10!
    -   !begin-bullet!
        `cur_data()` and `cur_data_all()`. Deprecated in 1.1.0, use
        `pick()` instead.

        !end-bullet!
    -   !begin-bullet!
        The `...` argument of `across()`. Deprecated in 1.1.0, use an
        anonymous function instead.

        !end-bullet!
    -   !begin-bullet!
        Using `by = character()` to perform a cross join. Deprecated in
        1.1.0, use `cross_join()` instead.
...
-   !begin-bullet!
    ...
    !begin-bullets-11!
    -   !begin-bullet!
        The `dplyr.legacy_locale` global option. If you used this to
        affect the ordering of `arrange()`, use `arrange(.locale =)`
        instead. If you used this to affect the ordering of
        `group_by() |> summarise()`, follow up with an additional call
        to `arrange(.locale =)` instead (#7760).
        !end-bullet!
